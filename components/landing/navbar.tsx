...
export function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200/50 bg-[#f4f4f5]/80 backdrop-blur-xl">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    {!isSignedIn ? (
                        <>
                            <Link href="/sign-in">
                                <Button variant="ghost" className="hidden text-zinc-600 hover:text-zinc-900 hover:bg-zinc-200/50 sm:flex">
                                    Sign In
                                </Button>
                            </Link>
                            <Link href="/sign-up">
                        ...
                        <>
                            <Link href="/dashboard">
                                <Button variant="ghost" className="text-zinc-600 hover:text-zinc-900 hover:bg-zinc-200/50">
                                    Dashboard
                                </Button>
                            </Link>
                            <button onClick={handleSignOut} className="flex items-center gap-1.5 text-sm text-zinc-600 hover:text-zinc-900 transition-colors">
