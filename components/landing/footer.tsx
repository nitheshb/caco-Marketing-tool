...
export function Footer() {
    return (
        <footer className="bg-zinc-50 landing-grain" aria-labelledby="footer-heading">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 py-10 sm:py-12">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
                        <div className="max-w-xs shrink-0">
                            <Link href="/" className="flex items-center gap-3">
                                ...
                                <span className="text-2xl font-semibold text-zinc-900">Agent Elephant</span>
                            </Link>
                    ...
                    <div className="mt-12 pt-8 border-t border-zinc-200/60 flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-5">
                            <a href="#" className="text-zinc-400 hover:text-zinc-600 transition-colors" aria-label="X (Twitter)">
                                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                            </a>
                            <a href="#" className="text-zinc-400 hover:text-zinc-600 transition-colors" aria-label="GitHub">
                            ...
                            <a href="#" className="text-zinc-400 hover:text-zinc-600 transition-colors" aria-label="LinkedIn">
